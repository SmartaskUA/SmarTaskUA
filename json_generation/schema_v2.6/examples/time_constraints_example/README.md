# Time Window Constraints Example (v2.5)

This example demonstrates time window constraint features using Allen Interval Algebra (`EQUALS`, `INCLUDE`, `EXCEPT`) combined with operating hours management (v2.5).

## Overview

This example shows how to use:
- Time window constraints in `schedule_input.csv` for precise employee scheduling
- Operating hours in `operating_hours.csv` to define when the facility is open (v2.5 NEW)
