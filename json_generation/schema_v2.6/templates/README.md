...
- `workPeriod` - Work period code (M, T, N, etc.)
...
2030-10-02,M,Storage,2,3,2,06:00,14:00
2030-12-25,M,ALL,1,1,1,10:00,14:00
```
...
- Work period definitions with default timeRange - v2.6
...
### Step 3: Create Demand Requirements (CSV) - v2.6 with Optional Times
...
- [ ] WorkPeriod codes in demand.csv match JSON `demand.workPeriods[].code`
