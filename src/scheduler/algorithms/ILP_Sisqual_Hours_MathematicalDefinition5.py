...
class SisqualProblem5ILP:
    ...
    def build_model(self):
        ...
        # most important skills in the Sisqual alarm order. Penalties are cumulative
        # hierarchy weights, not raw rank numbers, so one higher-priority downgrade
        # is more important than two downgrades one level below it.
