...
import pandas as pd
import holidays
from algorithms.engines.rules_engine import RuleEngine, register_default_ilp_handlers
from algorithms.contexts.ILPContext import ILPContext
...
class ILPEngine:
    ...
    def build(self):
        ...
        from algorithms.rules.handlers.rules_handlers_ilp import i_one_shift_per_day
...
def solve(vacations, minimuns, employees, maxTime, year=2025, shifts=2, rules=None):
    ...
    from algorithms.utils import TEAM_ID_TO_CODE, get_team_id  # ensure imported
    min_required = {}
    ...
    from algorithms.utils import schedule_to_table
