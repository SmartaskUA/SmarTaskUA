...
def analyze(file, holidays, mins, employees, year=2025):
    ...
    mins_required_list = list(mins_required_ordered.values())
    ...
    for i, (key, actual_count) in enumerate(mins_final_ordered.items()):
        if i < len(mins_required_list):
            required = mins_required_list[i]
    ...
    # Calculate minimums gaps (keep this for compatibility)
    missed_team_min = compare_minimums(mins_required_list, mins_final_list)
    

    # Calculate minimums and ideals gaps
    missed_team_min = compare_minimums(mins_required_list, mins_final_list)
    ...
    if has_ideals:
        ...
        ideals_required_list = list(ideals_required_ordered.values())
        missed_team_ideal = compare_minimums(ideals_required_list, mins_final_list)
    else:
        missed_team_ideal = 0
        print("[INFO] No ideal requirements provided - missedTeamIdeal set to 0")

    print(f"[DEBUG] Minimums Missed: {missed_team_min}")
    print(f"[DEBUG] Coverage Gaps: {hourlyCoverageGaps}")
