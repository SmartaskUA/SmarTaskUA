...
def solve():
    ...
    print("\nTempo de execução:", round(execution_time, 2), "segundos")
    print("Número de iterações:", cont)

    # Salva CSV
    salvar_csv(horario, Ferias, nTurnos, nDias, Prefs)

    # Lê CSV de volta e retorna como lista
    schedule = []
...
if __name__ == "__main__":
    resultado = solve()
    for linha in resultado[:5]:  # Mostra as 5 primeiras linhas como exemplo
        print(linha)
