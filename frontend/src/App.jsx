...
import TeamEmployees from "./Manager/TeamEmployees";
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/manager/team/:teamId/employees" element={<ProtectedRoute role="manager"><TeamEmployees /></ProtectedRoute>} />
